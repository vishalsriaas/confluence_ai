...
def after_install() -> None:
    ...
    ensure_repeat_followup_defaults()
...
def ensure_repeat_followup_defaults() -> None:
    if not frappe.db.exists("DocType", "AI Repeat Follow Up Settings"):
        return
    from confluence_ai.services.repeat_followup import ensure_defaults
    ...
    settings.update(
        {
            ...
            "enable_whatsapp_ai_summary": 1,
            "whatsapp_summary_provider": "Gemini",
            "whatsapp_summary_model": "gemini-2.5-flash",
            "whatsapp_summary_base_url": "https://generativelanguage.googleapis.com/v1beta",
            "whatsapp_summary_timeout_seconds": 20,
            "whatsapp_summary_max_messages": 100,
            "whatsapp_summary_max_input_chars": 12000,
            "whatsapp_summary_max_output_chars": 1500,
