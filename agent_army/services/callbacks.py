...
from agent_army.services.auth import sign_payload
from agent_army.services.utils import as_json, create_error
...
def post_batch_callback(batch_name: str, event_type: str, payload: dict) -> dict:
    ...
    secret = frappe.conf.get("agent_army_callback_secret") or ""
